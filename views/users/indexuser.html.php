    ...
    <div class="">
      ...
      method="post">
          ...
          <div class="form-group">
            <input type="text" name="title" value="<?php if (isset($_POST['title'])){echo htmlentities($_POST['title']);} ?>" class="form-control" placeholder="Title"  autocomplete="off">
          </div>
          <div class="form-group">
            <input type="text" name="chapo" value="<?php if (isset($_POST['chapo'])){echo htmlentities($_POST['chapo']);} ?>" class="form-control" placeholder="Chapo"  autocomplete="off">
          </div>
          <div class=" form-group ">
    ...
    <form action="index.php?controller=Postcontroller&task=validposts" method="post">
      ...
      <div class="valider">
        <?php foreach ($comments as $comment) : ?>
          <br>
          <div class=""><?= htmlentities($comment->comment) ?> </div>
          <a class="btn btn-success btn-outline-light"href="delete-comment.php?uuid=<?= htmlentities($comment->uuid) ?>" >Valider</a>
        <?php endforeach ?>
      </div> 
    </form>      
  </div>
