        ...
        <div class="col-lg-4" id="carte" >
          <div class="card border-light mb-4">
            <div class="card-header text-light bg-success text-center"><?= $article->title ?> </div>
              ...
              <div class="card-footer bg-success text-center pb-0"><p><a class="btn btn-outline-light btn-warning " href="/?controller=postcontroller&task=showOnePost&UUid=<?= $article->uuid ?>">View details &raquo;</a></p></div>
